...
const NewsLetter = () => {
  ...
  const handleSubscribeClick = async (e) => {
    ...
    try {
      ...
      // Show acknowledgment popup after a slight delay (e.g., 200ms)
      setTimeout(() => {
        setShowPopup(true);
      }, 200);
  ...
  return (
    <div>
      ...
      {showPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-[#E7F0E9] relative rounded-lg p-6 w-full max-w-[600px] mx-4 lg:mx-0 lg:pt-8   lg:px-10 max-h-[90vh] overflow-y-auto">
            <div className="absolute top-3 right-3 ">
              ...
              <button
                className="text-black text-xl pb-[2] font-bold"
            ...
            <div className="flex flex-col lg:flex-row gap-6 mt-5">
              ...
              <div className="w-full lg:w-1/2">
                <div className="flex items-center h-full my-4 text-gray-700">
                  <div className="space-y-3">
                    <h2 className="text-3xl font-[800] text-[#3B715A]">
                      Thank You For Subscribing Our News Letter
                    </h2>
                    <p className="text-[1rem]">
                      You will receive updates and exclusive offers in your
                      inbox soon. Stay tuned!
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex justify-center my-6">
              <button
                className="bg-[#3B715A] text-white px-11 py-2 rounded-lg mx-2"
                onClick={handleClosePopup}
              >
                OK
              </button>
