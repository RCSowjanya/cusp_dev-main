...
const validationSchema = Yup.object().shape({
  ...
  reference_site_pictures_upload: Yup.array().of(
    Yup.mixed().test(
      "fileSize",
...
const JoinUsUploads = ({ onPrevious, onSubmit, saveFiles, saveData }) => {
      ...
      <div className="bg-[#e3d5d5] flex justify-center py-[4%] items-center max-[1000px]:px-[2%]">
        <div className="px-[3%] bg-white shadow-lg max-w-3xl h-full mx-auto py-[2%]">
          ...
          <form className="space-y-4" onSubmit={formik.handleSubmit}>
            ...
            <p className="text-gray-600 text-[12px] sm:text-left">
            ...
            <p className="text-gray-600 text-[12px] text-center sm:text-left">
